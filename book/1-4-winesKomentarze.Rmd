...
<mark> Uwagi ogólne </mark> 

<mark> Odnośniki do literatury - wrzućcie do bibtex i zgodnie z instrukcją jak ich użyć cytujcie w tekście. </mark> 
...
In order to look at the nature of this data, four well-known algorithms have been trained from data divided into <mark>  1199 observations for the training set and 400 for the test set. (gdzie się podziała jedna obserwacja?)</mark> 
...
<mark> Tabele starajmy się wrzucać do Rmd w markdown, a nie screen </mark>
...
<mark> Wykresy BD mogłyby być w lepszej rozdzielczości </mark>
