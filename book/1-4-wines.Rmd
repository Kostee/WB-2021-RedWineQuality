...
Professional research was conducted in 2015. Experts António M. Jordão, Alice Vilela and Fernanda Cosme completed a set of activities, the result of which was the article *From Sugar of Grape to Alcohol of Wine: Sensorial Impact of Alcohol in Wine*. They indicated in it that the quality of grapes, as well as wine quality, flavor, stability, and sensorial characteristics depends on the content and composition of several different groups of compounds from grapes. One of these groups of compounds are sugars and consequently the alcohol content quantified in wines after alcoholic fermentation. During grape berry ripening, sucrose transported from the leaves is accumulated in the berry vacuoles as glucose and fructose. 

TODO:
https://www.mdpi.com/2306-5710/1/4/292/htm (zaczete wyzej)
...
The experiment is undoubtedly successful and with a probability close to 1 it confirms two facts: the quality of the wines is due to their higher alcohol content, but up to a certain threshold; and modern solutions of explainable artificial intelligence bring valuable results that bring new valuable information about the models of black boxes, which at the same time are consistent with the nature of the data sets on which they were made. Different approaches bring various useful results and it is difficult to indicate better or worthy solutions - the seven methods mentioned complement each other in their own way, but each allows us to look at the problem of analysis from a different perspective.

Leaving aside the topic of the success of using the proposed solutions, one must bear in mind, however, that the results of the experiment cannot be viewed as a whole. It must be remembered that the world of wines is very broadly understood and that for example artificially fortified wines should be considered differently. However, the proposed data set concerns only a certain group of wines, and the number of experts was not a representative group which results in the fact, that it is difficult to speak of 100% objectivity in the assessment. Either way, the surgeries performed largely approximate the idea of the overall effect of alcohol on quality and confirm previous research by wine experts from a biochemical point of view.
